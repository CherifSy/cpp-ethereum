...
void printHelp()
{
	...
	cout << setw(30) << "--seed <string>" << setw(25) << "Define a seed for random test\n";
...
Options::Options(int argc, char** argv)
{
	...
	{
		if (!randomTestSeed.empty())
		{
			cerr << "--seed <string> could be used only with --createRandomTest \n";
			exit(1);
		}
	}
